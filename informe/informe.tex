...
que conserva 10 de 44 características y alcanza un \textbf{RMSE de test de 4739{,}33
...
\midrule
Ganador de la CV (Lasso grado 4)      & 494 & 20 & $4647{,}34$ \\
\textbf{Producción (Lasso grado 2)}   & 44  & 10 & $\mathbf{4739{,}33}$ \\
\midrule
Referencia: lineal simple (grado 1)   & 8   & 8  & $6057{,}69$ \\
Baseline: predecir siempre la media   & --- & 0  & $11963{,}43$ \\
\bottomrule
\end{tabular}
\end{table}

Pasar de 494 a 44 características cuesta \destacado{$+92{,}0$ dólares de RMSE}, un 2\,\%. Es un
...
\textbf{4739{,}33 dólares} --- el RMSE de \textbf{test} del modelo de producción,\\
...
\begin{itemize}
  \item El conjunto de test tiene \textbf{267 filas}. El $4739{,}33$ es en sí mismo una
